...
export default function HomePage() {
    return (
        <>
            {/* Hero Section */}
            <section className="relative bg-brand-dark text-white overflow-hidden py-24 md:py-32">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/crops">
                            <Button size="lg" className="w-full sm:w-auto bg-white text-brand hover:bg-surface-muted">
                                Explore Marketplace
                            </Button>
                        </Link>
                        <Link href="/archive">
            ...
            <section className="py-20 bg-surface-muted">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-text-main mb-4">What We Offer</h2>
                        <div className="w-24 h-1 bg-brand mx-auto rounded-full"></div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-surface p-8 rounded-2xl shadow-card text-center hover:-translate-y-1 transition-transform duration-300">
                            <div className="w-16 h-16 bg-brand-tint rounded-2xl flex items-center justify-center mx-auto mb-6 text-brand">
                                <Leaf size={32} />
                            </div>
            ...
            <section className="py-20 bg-brand text-white">
                <div className="container mx-auto px-4 text-center max-w-3xl">
                    ...
                    <Link href="/crops">
                        <Button size="lg" className="bg-white text-brand hover:bg-surface-muted shadow-lg shadow-black/10">
                            Browse Marketplace
                        </Button>
                    </Link>
                </div>
